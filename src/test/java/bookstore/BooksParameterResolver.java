...
public class BooksParameterResolver implements ParameterResolver {
    ...
    public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
        ...
        return Objects.equals(parameter.getParameterizedType().getTypeName(), "java.util.Map<java.lang.String, bookstore.Book>");
    }
    ...
    private Map<String, Book> getBooks(){
        ...
        books.put("Clean Code", new Book("Clean Code", "Robert Cecil Martin", LocalDate.of(2008, Month.AUGUST, 1)));
        ...
        books.put("Java Unit Testing", new Book("Java Unit Testing","Rahul Sharma", LocalDate.of(2017, Month.NOVEMBER, 10)));
